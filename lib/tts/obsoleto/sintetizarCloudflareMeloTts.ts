// OBSOLETO (2026-07-04) — substituído por Edge TTS (msedge-tts), ver
// lib/tts/sintetizar.ts e docs/historico.md. Motivo da troca: testado
// com credencial real, mas REPROVADO por ouvido — a pronúncia
// misturava fonética de outro idioma (confirmava o risco já
// documentado abaixo: português não consta na lista oficial de
// idiomas do MeloTTS). Mantido aqui só de referência — não importar em
// código novo.
//
...
//
// RISCO CONHECIDO, CONFIRMADO NA PRÁTICA: a documentação oficial do
...
// O teste com a API real confirmou o risco: pronúncia misturada,
// reprovada por ouvido.
//
