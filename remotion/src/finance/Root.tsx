...
import { VideoLongo, TOTAL_FRAMES } from "./longo/VideoLongo";
...
export const FinanceRoot: React.FC = () => (
  <>
    ...
    <Composition id="VideoLongo171" component={VideoLongo} durationInFrames={TOTAL_FRAMES} fps={30} width={1920} height={1080} />
